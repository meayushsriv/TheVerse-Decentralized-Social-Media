...
@Component({
  selector: 'app-testcoin',
  templateUrl: './testcoin.component.html',
  styleUrls: ['./testcoin.component.css']
})
export class TestcoinComponent implements OnInit {
